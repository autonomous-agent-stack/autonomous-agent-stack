...
class HousekeeperDispatchRequest(StrictModel):
    """Frontdesk dispatch input limited to session-scoped intent drafting."""
...
class HousekeeperApprovalRequest(StrictModel):
    """Approval prompt generated by the frontdesk for risky requests."""
...
class HousekeeperTaskRead(StrictModel):
    """Frontdesk draft state before the control plane makes the final dispatch."""
    ...
    approval_request: HousekeeperApprovalRequest | None = None

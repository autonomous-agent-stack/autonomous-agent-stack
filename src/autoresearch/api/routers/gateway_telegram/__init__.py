...
from autoresearch.shared.models import OpenClawSessionCreateRequest, OpenClawSessionEventAppendRequest
...
__all__ = ["router", "compat_router", "OpenClawSessionCreateRequest", "OpenClawSessionEventAppendRequest"]

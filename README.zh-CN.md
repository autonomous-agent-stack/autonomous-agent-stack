...
- 快策略路由与慢编排（管家：规则优先、模型补位、重活上 Hermes）— [docs/decisions/fast-policy-router-and-slow-orchestration-v1.md](docs/decisions/fast-policy-router-and-slow-orchestration-v1.md)

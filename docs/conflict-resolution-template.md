...
# -> {'chat_id': '<YOUR_TELEGRAM_CHAT_ID>', 'message_thread_id': 2}
```
...
# 应输出：{'chat_id': '<YOUR_TELEGRAM_CHAT_ID>', 'message_thread_id': 2}
"
```
...
# 应输出：AUTORESEARCH_TG_CHAT_ID="<YOUR_TELEGRAM_CHAT_ID>"
```

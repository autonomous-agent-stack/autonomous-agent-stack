...
2. single eligible candidate
3. otherwise fail closed as ambiguous
...
that error unchanged. It must not pick the first manifest or degrade ambiguity
into execution.
...
- multiple eligible agents without explicit override: reject routing input

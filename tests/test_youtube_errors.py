"""Tests for YouTube error classification and serialization."""
...
class TestYouTubeFailureClassification:
    def test_frozen_dataclass(self) -> None:
        classification = YouTubeFailureClassification(
            YouTubeFailureKind.NETWORK_FAILURE,
            retryable=True,
        )
        assert classification.failure_kind == YouTubeFailureKind.NETWORK_FAILURE
        assert classification.retryable is True

    def test_default_not_retryable(self) -> None:
        classification = YouTubeFailureClassification(YouTubeFailureKind.VIDEO_UNAVAILABLE)
...
class TestYouTubeAgentError:
    def test_basic_construction(self) -> None:
        ...
        assert str(err) == "extractor failed"
    ...
    def test_to_api_detail_no_stage(self) -> None:
        ...
        assert err.to_api_detail()["failed_stage"] is None

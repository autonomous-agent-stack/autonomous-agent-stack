...
from src.gateway.message_mirror import MessageMirror  # noqa: E402
...
class TestMessageMirror:
    ...
    async def test_mirror_to_backup_success(self):
        ...
        result = await mirror.mirror_to_backup(original_message, -1001234567890, 110)
    ...
    async def test_mirror_to_backup_without_thread(self):
        ...
        result = await mirror.mirror_to_backup(original_message, -1009876543210, None)
    ...
    async def test_get_mirror_stats(self):
        ...
        await mirror.mirror_to_backup(
            {"chat_id": -1001234567890, "thread_id": 10, "message_id": 1, "text": "测试"},
            -1001234567890,
            110,
        )

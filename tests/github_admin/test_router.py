...
def test_github_admin_routes_return_dry_run_payloads_and_preflight(tmp_path: Path) -> None:
    ...
    try:
        with TestClient(app) as client:
            ...
            assert plan_payload["summary"]["ready_to_execute_count"] == 1
            assert plan_payload["preflight"]["target_owner_probe"]["readiness"] == "ready"

...
- [ai-agent-learning-hub](https://github.com/srxly888-creator/ai-agent-learning-hub) - AI Agent 系统化学习中心
- [openclaw-agent-forge](https://github.com/srxly888-creator/openclaw-agent-forge) - OpenClaw Agent Forge
...
- [ai-tools-compendium](https://github.com/srxly888-creator/ai-tools-compendium) - 159 个 AI 工具深度研究报告合集
...
- [claude_cli](https://github.com/srxly888-creator/claude_cli) - Claude Code CLI 学习指南
- [claude-code-learning](https://github.com/srxly888-creator/claude-code-learning) - Claude Code 完整学习资源
- [claude-cookbooks-zh](https://github.com/srxly888-creator/claude-cookbooks-zh) - Claude Cookbooks 中文版
...
- [youtube-subtitles](https://github.com/srxly888-creator/youtube-subtitles) - YouTube 字幕下载工具
- [youtube-subtitles-classified](https://github.com/srxly888-creator/youtube-subtitles-classified) - YouTube 字幕分类库
- [ai-knowledge-graph](https://github.com/srxly888-creator/ai-knowledge-graph) - YouTube AI 知识字幕库（393 个）
...
| 文件 | 主题 | 日期 | 价值 |
|------|------|------|------|
| [zellij-vscode-toolkit.md](zellij-vscode-toolkit.md) | Zellij + VSCode 工具包 | - | ⭐⭐⭐ |
| [autoresearch-gpu-requirements.md](autoresearch-gpu-requirements.md) | AutoResearch GPU 需求 | - | ⭐⭐⭐ |
| [test-framework-revised-plan.md](test-framework-revised-plan.md) | 测试框架修订计划 | - | ⭐⭐⭐ |
| [notebooklm-workflow-integration-2026-03-24.md](notebooklm-workflow-integration-2026-03-24.md) | NotebookLM 工作流集成 | 2026-03-24 | ⭐⭐⭐ |
...
| [2026-03-21.md](2026-03-21.md) | 2026-03-21 | 项目启动 |
...
- `Claude CLI` → [claude_cli 仓库](https://github.com/srxly888-creator/claude_cli)

### 项目相关
- `Token 燃烧` → [Token 燃烧](#5-token-燃烧)
- `YouTube` → [YouTube 字幕](#4-youtube-字幕)
- `决策` → [决策记录](#6-决策记录)
